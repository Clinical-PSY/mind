...
내담자의 이 발화에 최적화된 치료적 반응을 제시하라.
단순 예시가 아니라, **이 내담자의 이 순간**에 맞게 구체적으로 작성할 것.

- **추천 반응**: (Level 3~4 수준의 반응 — 큰따옴표로 반드시 묶어 제시)
- **공감 포인트**: 이 반응이 포착한 내담자의 이면 정서 또는 핵심 의미
- **치료적 근거**: 왜 이 반응이 더 치료적인가 (1~2문장, 이론적 근거 포함)
- **예상 효과**: 이 반응 이후 내담자가 어떻게 반응할 가능성이 높은가
