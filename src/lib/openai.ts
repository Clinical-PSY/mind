...
### 공감 수준 평가 (1~5)
- Level 1: 내담자 의미 놓침 / 충고·설교·해석 중심
- Level 2: 내용만 단순 반복
- Level 3: 명시된 감정 정확히 반영
- Level 4: 암시된 감정과 의미 반영
- Level 5: 내담자도 미처 자각 못한 경험을 정교하게 언어화 → 치료적 통찰 촉진

### 로저스 핵심조건 (1~5점)
- **공감(Empathy)**: 내담자의 내적 준거틀 이해 정도
- **무조건적 긍정적 존중(UPR)**: 평가 없는 수용 정도
- **진실성(Congruence)**: 진정성 수준

### 상담기술 분류
단순반영 / 감정반영 / 의미반영 / 즉시성 / 명료화 / 요약 / 재구조화 / 직면 / 개방형질문 / 폐쇄형질문 / 정보제공 / 조언 / 해석 / 자기개방

### 인본주의적 수준
- 내담자 중심성, 경험 vs 문제 중심, 정서 탐색 수준, 자기이해·자기수용 촉진 정도

### 치료적 적절성
- 매우 비치료적 (충고/설득/평가/훈계/문제해결 강요)
- 부분적 치료적 (내용 이해 있으나 정서 접촉 부족)
- 치료적 (정서와 경험을 깊이 탐색)
- 매우 치료적 (자기탐색과 통찰 촉진)
...
- ✅ **잘한 점**: 상담자가 효과적으로 수행한 부분
- ⚠️ **놓친 부분**: 더 탐색했어야 할 부분과 이유
- 📚 **다음 회기 과제**: 상담자가 연습해야 할 기술
- 💡 **대안적 개입 관점**:
  - 인본주의 상담 관점
  - 인간중심상담(PCT) 관점
  - 정서중심치료(EFT) 관점
...
## 출력 원칙
- 상담자 반응을 비판하지 말고 교육적 슈퍼비전 관점으로 분석
- 모든 평가는 반드시 근거 제시 ("왜 이 반응이 치료적인지" 설명)
- 공감 수준과 로저스 핵심조건을 분석 중심에 둘 것
- 내담자의 정서 경험 최우선
- 실제 상담기술 훈련에 즉시 활용 가능할 정도로 구체적으로 작성
- 한국어, 전문적 존댓말`;
